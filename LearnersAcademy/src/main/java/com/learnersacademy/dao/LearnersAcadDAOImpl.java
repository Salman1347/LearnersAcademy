...
public class LearnersAcadDAOImpl implements LearnersAcadDAO{
	...
	public boolean userLogin(String username, String password) throws BusinessException {
		...
		{
			String sql="select 1 from mydb.tab_user where username=? and password=?";
	...
	public List<SubjectObj> listSubject() throws BusinessException {
		...
		try(Connection connection=MySqlConnection.getConnection())
		{
			String sql="select sub_name,sub_id,sub_lang,class_id,teacher_id from mydb.tab_subject";
			PreparedStatement  preparedStatement=connection.prepareStatement(sql);
	...
	public List<ClassObj> listClasses() throws BusinessException {
		...
		try(Connection connection=MySqlConnection.getConnection())
		{
			String sql="select class_id,division,std from mydb.tab_class";
			PreparedStatement  preparedStatement=connection.prepareStatement(sql);
	...
	public List<TeacherObj> listTeacher() throws BusinessException {
		...
		try(Connection connection=MySqlConnection.getConnection())
		{
			String sql="select teacher_id,teacher_name,teacher_category,experience from mydb.tab_teacher";
			PreparedStatement  preparedStatement=connection.prepareStatement(sql);
	...
	public List<StudentObj> listStudents() throws BusinessException {
		...
		try(Connection connection=MySqlConnection.getConnection())
		{
			String sql="select student_id,student_name,student_dob,class_id from mydb.tab_student";
			PreparedStatement  preparedStatement=connection.prepareStatement(sql);
	...
	public boolean deleteSubject(Integer subjectID) throws BusinessException {
		try(Connection connection=MySqlConnection.getConnection())
		{
		String sql="delete from mydb.tab_subject where sub_id=?";
		PreparedStatement preparedStatement=connection.prepareStatement(sql);
	...
	public boolean deleteStudent(Integer studentID) throws BusinessException {
		try(Connection connection=MySqlConnection.getConnection())
		{
		String sql="delete from mydb.tab_student where student_id=?";
		PreparedStatement preparedStatement=connection.prepareStatement(sql);
	...
	public boolean addSubject(SubjectObj subject) throws BusinessException {
		try(Connection connection=MySqlConnection.getConnection())
		{
		String sql="insert into mydb.tab_subject (sub_name,sub_lang) values (?,?)";
		PreparedStatement preparedStatement=connection.prepareStatement(sql);
	...
	public boolean addClass(ClassObj cls) throws BusinessException {
		try(Connection connection=MySqlConnection.getConnection())
		{
		String sql="Insert into mydb.tab_class (std,division) values(?,?)";
		PreparedStatement preparedStatement=connection.prepareStatement(sql);
	...
	public boolean addTeacher(TeacherObj teacher) throws BusinessException {
		try(Connection connection=MySqlConnection.getConnection())
		{
		String sql="Insert into mydb.tab_teacher(teacher_name,teacher_category,experience) values(?,?,?)";
		PreparedStatement preparedStatement=connection.prepareStatement(sql);
	...
	public boolean addStudent(StudentObj student) throws BusinessException {
		try(Connection connection=MySqlConnection.getConnection())
		{
		String sql="Insert into mydb.tab_student(student_name,student_dob) values(?,?)";
		PreparedStatement preparedStatement=connection.prepareStatement(sql);
	...
	public boolean updTeacher(TeacherObj teacher) throws BusinessException {
		...
		{
		String sql="update mydb.tab_teacher tt set tt.teacher_name=nvl(?,tt.teacher_name),"
	...
	public List<Object> generateReport(ClassObj cls) throws BusinessException {
		...
		try(Connection connection=MySqlConnection.getConnection())
		{
			String sql="select sub_name,sub_id,sub_lang,class_id,teacher_id from mydb.tab_subject where class_id=?";
			PreparedStatement  preparedStatement=connection.prepareStatement(sql);
			...
			String sql2="select teacher_id,teacher_name,teacher_category,experience from mydb.tab_teacher tt where "
			...
			String sql3="select student_id,student_name,student_dob,class_id from mydb.tab_student where class_id=?";
